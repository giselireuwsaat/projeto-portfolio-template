...
// let resultado = titulo.replace ('HI','x')

// console.log(resultado)

let nome  = document.getElementById("titular"); 
   
    document.("titular") = res;
  }
...
// são da classe “icon”.
// Elementos
// 1. Precisamos criar um botão usando JavaScript. A ideia é que ele fique ao
// lado do botão de abracadabra e mostre imagem da coruja. Por sua vez, o
// botão de abracadabra deve fazer essa imagem desaparecer.
// 2. Traduzir todos os textos da top nav para português. Para isso, podemos
// usar os ids deles com o textContent.
// 3. Utilizando removeChild, remover o ícone do FourSquare das redes sociais
// (classe “.social”).